...
export default function EditDogForm({ dog, onCancel }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 divide-y divide-gray-200">
      <div className="space-y-8 divide-y divide-gray-200">
        ...
        <div className="pt-8">
          <div>
            <h3 className="text-lg font-medium leading-6 text-gray-900">Edit Dog Information</h3>
        ...
        <div className="pt-8">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update information about your dog's health and behavior.
            </p>
          </div>
